...
import { get_content_data } from "../../../redux/content/actions";
                            ...
                            {props.contentlist?.data.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <span onClick={() => handleShowvideo()}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
