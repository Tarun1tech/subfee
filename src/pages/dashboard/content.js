                    ...
                    <div className="row">
                        <div className="col-md-12 mt-4 mb-4">
                            <div className="video-upload-sec">
                                <h6 style={{color: "#fff"}} className="stats-page-title">Upload nieuwe content</h6>
                                <button type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#video-submit">
                                After video upload
                                </button>
                                ...
                                <div className="dash-dragger">
                                    <Dragger {...props}>
                                        <InboxOutlined />
                                        <p className="ant-upload-text text-center">Sleep je .MP4 bestand hier naartoe</p>
                                    </Dragger>
                                </div>
                            </div>
                        </div>
