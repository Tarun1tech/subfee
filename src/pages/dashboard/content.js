          ...
          <div className="row">
            <div className="col-md-12 content-first-row-gap">
              <div className="d-flex justify-content-between align-items-enter">
                ...
                <button className="content-upload-btn" data-bs-toggle="modal" data-bs-target="#video-submit">Selecteer een bestand</button>
                </div>
                <div className="content-upload-btns-back">
                  <p><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button className="content-upload-btn" data-bs-toggle="modal" data-bs-target="#photo-submit">Selecteer een bestand</button>
                </div>
                <div className="content-upload-btns-back">
                  <p><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
