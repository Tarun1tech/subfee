                        ...
                        <div className="col-md-12">
                            ...
                            <nav>
                                  ...
                                  <div className='row'>
                                    ...
                                    <div className='col-md-10 mt-4'>
                                        <div className='setting-tab-content'>
                                          ...
                                          <div className='text-center'><button style={{backgroundColor: "#FE6A6A"}} className='mt-4 maroon-btn'>Alle subscribers bekijken</button></div>
                                        </div>                                        
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-5'>
                                          <div className='setting-tab-content'>
                                            <h6 className='stats-page-title'>Behaalde omzet (tijdlijn)</h6>
                                          </div>
                                    </div>
                                    <div className='col-md-10 mt-4'>
                                        <div className='setting-tab-content'>
