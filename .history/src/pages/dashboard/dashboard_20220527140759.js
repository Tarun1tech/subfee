...
const Dashboard = () =>{
  const options = {
    ...
    series: [{
      name: 'Installation',
      data: [1200,2000,3500,4200,47000]
  }, {
      name: 'Manufacturing',
      data: [1000,2500,3000,5500]
  }],
  }
    return(
        <div>
                    ...
                    <div className="setting-tab">
                          <div className="setting-tab-content">
                            ...
                            <div className="dash-bottom-one text-center">
                              <h2>€ 17.4k</h2>
                              <p>Update je betaalmethode op de <span>instellingen</span> pagina.</p>
                              <div className="web-btn"><a href="#">Bekijk de inzichten</a></div>
                            </div>
                          </div>
                    </div>
                    </div>
                              ...
                              <ul>
                                <li>
                                  <div className="d-flex justify-content-start align-items-center">
                                    <div className="notif-img"><img src={notifImg} /></div>
                                    <div className="notif-content">
                                      <div className="d-flex justify-content-between align-items-center">
                                        <h6>John Doe</h6>
                                        <span>13m</span>
                                      </div>
                                      <p>Gaf commentaar op <span>videonaam</span></p>
                                    </div>
                                  </div>
                                </li>
                                <li>
